        ...
        <div class="recent-applicant">
            ...
            <form class="post-form-wrapper"  method="POST" autocomplete="off">
                ...
                <?php
                  ...
                  $sql = "select * from admin_info WHERE AdminUsername = '$username' ";
                  $result = mysqli_query($connect,$sql); 
                  $row = mysqli_fetch_assoc($result);
                  if(is_array($row))
                  {
                  ?>
                  <br><p>Admin ID: <b><?php echo $row['AdminID']; ?></p></b></br>
                  <br><p>Admin Full Name: <b><?php echo $row['AdminFullName']; ?></p></b></br>
                  <br><p>Admin Username: <b><?php echo $row['AdminUsername']; ?></p></b></br>
                  <br><p>Admin Email: <b><?php echo $row['AdminEmail']; ?></p></b></br>
                  <br><p>Admin Phone Number: <b><?php echo $row['AdminPhone']; ?></p></b></br>
                  <br><p>Admin Address: <b><?php echo $row['AdminAddress']; ?></p></b></br>
